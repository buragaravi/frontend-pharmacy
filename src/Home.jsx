  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-16">        {/* Hero Section with Pattern */}
        ...
        <section className="py-16 bg-gradient-to-br from-gray-50 via-blue-50 to-blue-100">
        ...
        <section className="py-20 bg-gradient-to-br from-white via-blue-50 to-blue-100">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent mb-4">Powerful Features</h2>
        ...
        <section className="py-20 bg-gradient-to-br from-gray-50 via-blue-50 to-blue-100">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl md:text-4xl font-bold text-center bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent mb-12">
              What Our Users Say
            </h2>
          ...
          <div className="container mx-auto px-4 text-center text-white relative z-10">
            ...
            <form onSubmit={handleSubmit} className="max-w-md mx-auto flex gap-4">
              <input
                ...
                className="flex-grow px-4 py-3 rounded-xl text-gray-900 focus:outline-none focus:ring-2 focus:ring-white/50 shadow-lg backdrop-blur-sm bg-white/90 border border-white/20"
                required
              />
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                type="submit"
                className="bg-white/20 backdrop-blur-sm border border-white/30 text-white px-6 py-3 rounded-xl font-semibold hover:bg-white/30 transition-all duration-300 shadow-lg"
              >
                Subscribe
              </motion.button>
            </form>
