    ...
    <div className="p-4 md:p-6 min-h-screen bg-gradient-to-br from-blue-100 to-blue-200">
      <div className="max-w-2xl mx-auto">
        <div className="rounded-xl shadow-lg p-4 md:p-6 bg-white border border-blue-900">
          <h2 className="text-xl md:text-2xl font-bold text-blue-900 mb-6">Request Equipment</h2>
          <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
            ...
            {equipments.map((equipment, index) => (
              <div key={`equipment-${index}`} className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
                <div className="relative">
                  <label className="block text-sm font-medium text-blue-900 mb-1">Equipment Name</label>
                  <input
                    type="text"
            ...
            <button type="button" onClick={addEquipment} className="w-full py-2 text-blue-900 border-2 border-blue-600 rounded-lg hover:bg-blue-50 transition-colors">+ Add Another Equipment</button>
