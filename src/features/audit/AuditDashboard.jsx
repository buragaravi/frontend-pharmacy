            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-900">{dashboardData.stats.totalAssignments}</p>
                </div>
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-blue-600">{dashboardData.stats.activeAssignments}</p>
                </div>
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-green-600">{dashboardData.stats.completedAssignments}</p>
                </div>
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-red-600">{dashboardData.stats.overdueAssignments}</p>
                </div>
